      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 py-12 border-b border-gray-100">
          ...
          <div className="flex items-center gap-4">
            <Link href="/order" className="px-8 py-4 bg-brand-primary hover:bg-[#b0222e] text-white font-black uppercase tracking-widest text-xs rounded-xl transition-all duration-300 shadow-[0_10px_30px_rgba(230,57,70,0.3)] hover:shadow-[0_15px_40px_rgba(230,57,70,0.5)] hover:-translate-y-0.5">
              Order Online
            </Link>
            <a href="tel:+923001234567" className="px-8 py-4 bg-white border border-gray-200 text-brand-dark hover:border-brand-primary hover:text-brand-primary font-black uppercase tracking-widest text-xs rounded-xl transition-all duration-300 shadow-sm hover:-translate-y-0.5 flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 py-16">
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-3 mt-2">
              <a href="tel:+923001234567" className="flex items-center gap-3 text-sm text-brand-dark/60 hover:text-brand-primary transition-colors group font-medium">
              ...
              <a href="mailto:hello@zeefood.pk" className="flex items-center gap-3 text-sm text-brand-dark/60 hover:text-brand-primary transition-colors group font-medium">
                <span className="w-8 h-8 rounded-lg bg-brand-primary/10 flex items-center justify-center group-hover:bg-brand-primary/20 transition-colors">
                  <svg className="w-4 h-4 text-brand-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="flex items-center gap-3 text-sm text-brand-dark/60 font-medium">
                <span className="w-8 h-8 rounded-lg bg-brand-primary/10 flex items-center justify-center">
                  <svg className="w-4 h-4 text-brand-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {Object.entries(footerLinks).map(([title, links]) => (
            <div key={title}>
              <h4 className="text-xs font-black uppercase tracking-[0.2em] text-brand-dark mb-6 flex items-center gap-2">
        ...
        <div className="border-t border-gray-100 py-4 flex flex-col sm:flex-row items-center sm:items-end justify-between gap-6 relative">
          ...
          <div className="flex flex-col items-center sm:items-end gap-5">
            ...
            >
              <span className="text-[13px] font-black text-gray-400 uppercase tracking-widest group-hover:text-[#2563eb] transition-colors duration-300">
                POWERED BY
              </span>
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-8">
              <Link href="/privacy" className="text-[11px] text-brand-dark/40 hover:text-brand-primary transition-colors font-black uppercase tracking-widest">Privacy Policy</Link>
              <Link href="/terms" className="text-[11px] text-brand-dark/40 hover:text-brand-primary transition-colors font-black uppercase tracking-widest">Terms</Link>
              <Link href="/contact" className="text-[11px] text-brand-dark/40 hover:text-brand-primary transition-colors font-black uppercase tracking-widest">Contact</Link>
            </div>
          </div>
        </div>
