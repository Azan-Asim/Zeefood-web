        ...
        <div className="flex items-center py-2">
          <Link href="/" className="flex items-center gap-3 lg:gap-5 group">
            ...
            <div className="flex flex-col leading-none">
              <span className="text-[14px] lg:text-[16px] font-black text-brand-primary whitespace-nowrap mb-1 italic uppercase tracking-[0.35em]">
                {t("brandName")}
              </span>
              <span className="font-black text-brand-dark text-[1.4rem] lg:text-[ 1.6rem] tracking-tighter whitespace-nowrap leading-tight font-urdu">
                {t("brandSubtitle")}
              </span>
            </div>
          </Link>
