...
export default function RegisterPage() {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative z-20 w-full max-w-[440px] mx-4 mt-8 mb-8 rounded-3xl overflow-hidden shadow-[0_24px_64px_rgba(0,0,0,0.12),0_6px_20px_rgba(230,57,70,0.07)] border border-white/80"
        style={{
        ...
        <div className="px-6 py-5">
          <div className="w-full flex flex-col gap-3">
            ...
            <div className="flex flex-col text-center mb-1">
              <h1 className="text-[1.8rem] font-black tracking-tight text-[#1a0a04] leading-none mb-1">
                Join ZeeFood<span className="text-[#E63946]">.</span>
              </h1>
              <p className="text-[0.85rem] text-[#6b5a50] font-medium leading-snug">
                Create a free account to unlock your <span className="text-[#E63946] font-semibold">premium</span> dining experience.
              </p>
            </div>
            ...
            <form onSubmit={handleRegister} className="flex flex-col gap-3 mt-1">
              ...
              <div className="flex flex-col gap-0.5">
                <label htmlFor={nameInputId} className="text-[0.65rem] font-bold text-[#3d2414] uppercase tracking-widest pl-1">
                  Full Name
                </label>
                <div className={`relative flex items-center bg-white/70 border-2 rounded-xl overflow-hidden transition-all duration-300 shadow-sm ${state.nameFocus ? "border-[#E63946] shadow-[0_0_0_4px_rgba(230,57,70,0.1)]" : "border-[#e8d8cc] hover:border-[#d4a898]"}`}>
              ...
              {/* Phone input */}
              <div className="flex flex-col gap-0.5">
                <label htmlFor={phoneInputId} className="text-[0.65rem] font-bold text-[#3d2414] uppercase tracking-widest pl-1">
                  Phone Number
                </label>
              ...
              {/* Email field */}
              <div className="flex flex-col gap-0.5">
                <label htmlFor={emailInputId} className="text-[0.65rem] font-bold text-[#3d2414] uppercase tracking-widest pl-1">
                  Email Address
                </label>
              ...
              <label htmlFor={agreeId} className="flex items-start gap-2 cursor-pointer group mt-1">
                ...
                <span className="text-[0.7rem] text-[#6b5a50] leading-snug group-hover:text-[#1a0a04] transition-colors">
                  I agree to ZeeFood&apos;s <Link href="/terms" className="text-[#E63946] font-bold hover:underline">Terms of Service</Link> and <Link href="/privacy" className="text-[#E63946] font-bold hover:underline">Privacy Policy</Link>.
                </span>
              </label>
