...
export default function AboutSection() {
  ...
  return (
    <section className="py-10 sm:py-14 lg:py-16 2xl:py-20 bg-[#fbf7f2] overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12">
        
        {/* Header */}
        <div className="flex flex-col items-center mb-10 sm:mb-12 lg:mb-14 text-center">
          ...
          <h2 className="text-[clamp(2rem,8vw,3.75rem)] font-medium text-brand-dark mb-6 italic">
            {t("aboutSubtitle")}
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8">
          ...
          {/* Card 1: Fresh Food */}
          <div className="group relative bg-[#fffdf8] border border-brand-primary/10 p-6 sm:p-8 lg:p-12 rounded-2xl sm:rounded-[3rem] transition-all duration-500 hover:-translate-y-4 hover:border-brand-primary/25 hover:bg-brand-primary/5 shadow-[0_20px_50px_rgba(0,0,0,0.02)]">
            ...
            <h3 className="text-2xl font-black text-brand-dark mb-6 uppercase transition-colors group-hover:text-brand-primary">
              {t("freshFoodTitle")}
            </h3>
          ...
          {/* Card 2: Local Staff */}
          <div className="group relative bg-[#fffdf8] border border-brand-primary/10 p-6 sm:p-8 lg:p-12 rounded-2xl sm:rounded-[3rem] transition-all duration-500 hover:-translate-y-4 hover:border-brand-primary/25 hover:bg-brand-primary/5 shadow-[0_20px_50px_rgba(0,0,0,0.02)] lg:mt-12">
            {/* <div className="w-20 h-20 bg-white rounded-3xl flex items-center justify-center mb-10 shadow-xl group-hover:scale-110 transition-transform duration-500">
               <span className="text-4xl">👨‍🍳</span>
            </div> */}
            <h3 className="text-2xl font-black text-brand-dark mb-6 uppercase transition-colors group-hover:text-brand-primary">
        ...
        {/* My Vision Section */}
        <div className="mt-12 sm:mt-16 max-w-4xl mx-auto rounded-2xl sm:rounded-[2.5rem] border border-brand-primary/10 bg-gradient-to-br from-brand-primary/5 via-[#fffdf8] to-brand-secondary/5 p-6 sm:p-8 lg:p-12 shadow-sm text-center">
        ...
        {/* Journey + Highlights */}
        <div className="mt-10 sm:mt-14 lg:mt-16 grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 2xl:gap-10 items-start">
          <div className="rounded-2xl sm:rounded-[3rem] bg-[#fffdf8] border border-brand-primary/10 p-6 sm:p-8 lg:p-10 shadow-sm">
